...
public class Main {
    public static synchronized void main(String[] args) {
		...
		// tiles.add(new Space("Tax Space"));
    	tiles.add(new Property("Soekarno-Hatta", 22500, 3));
    	tiles.add(new Lot("Bali", 15000, 2));						// 6
		tiles.add(new Space("Chance"));
    	tiles.add(new Lot("Bandung", 20000, 2));
		tiles.add(new Lot("Banjarbaru", 20000, 2));
			// end of first row
    	...
    	tiles.add(new Property("Cicaheum", 27500, 3));
    	tiles.add(new Lot("Bogor", 27000, 4));						// 16
		tiles.add(new Space("Community Chest"));
    	tiles.add(new Lot("Tangerang", 27000, 4));
		tiles.add(new Lot("Bontang", 30000, 4));
			// end of second row
    	...
    	tiles.add(new Property("Gambir", 30000, 3));
    	tiles.add(new Lot("Jogja", 33000, 6));						// 26
    	tiles.add(new Lot("Lampung", 33500, 6));
    	tiles.add(new Property("PLTA", 37000, 2));		
    	tiles.add(new Lot("Lombok", 33000, 6));
    		// end of third row
		...
		tiles.add(new Property("Tanjung Priok", 36000, 3));
		tiles.add(new Space("Chance"));
		tiles.add(new Lot("Medan", 39000, 8));						// 36
		// tiles.add(new Space("Tax Space"));
